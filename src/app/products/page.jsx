...
export default function Products() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 mt-20">
      <h1 className="text-3xl font-bold mb-6 text-black text-center">Products</h1>
        ...
        {products.map(product => (
          ...
          >
            ...
            <div className="p-4 flex flex-col flex-grow">
              <span className="text-gray-700 text-xs mb-1">T-SHIRT</span>
              <span className="text-gray-500 text-xs mb-2">S M XL</span>
              <h2 className="font-bold text-lg mb-2 text-gray-700">{product.title}</h2>
